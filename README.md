...
and recurrent architectures, have shown remarkable success in video classification.
However, their lack of interpretability raises concerns in highstakes
...
studies worked on the violence detection with focus either on speed or accuracy
or both but not taking into account the generality over different kind of
video sources
